...
auto ARM7MemoryBus::ReadByteIO(u32 address) -> u8 {  
  switch (address) {
    ...
    case REG_KEYCNT|0:
      return keypad.control7.ReadByte(0);
    case REG_KEYCNT|1:
      return keypad.control7.ReadByte(1);  
    case REG_EXTKEYINPUT:
      return keypad.ext_input.ReadByte();
...
void ARM7MemoryBus::WriteByteIO(u32 address,  u8 value) {
  switch (address) {
    ...
    // Input
    case REG_KEYCNT|0:
      keypad.control7.WriteByte(0, value);
      break;
    case REG_KEYCNT|1:
      keypad.control7.WriteByte(1, value);
      break;
...
void ARM7MemoryBus::WriteHalfIO(u32 address, u16 value) {
  switch (address) {
    ...
    case REG_IPCFIFOSEND|2:
      ...
      break;
    case REG_KEYCNT:
      keypad.control7.WriteHalf(value);
    default:
